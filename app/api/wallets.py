...
@router.post(
    ...
    dependencies=[Depends(auth_required)],tags=["Wallets"]
)
...
@router.delete("/wallet/{wallet_id}", dependencies=[Depends(auth_required)],tags=["Wallets"])
...
@router.get("/wallet/{wallet_id}", dependencies=[Depends(auth_required)],tags=["Wallets"])
